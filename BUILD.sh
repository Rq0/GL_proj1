#!/bin/bash
mkdir out #
javac -encoding utf8 -d "./out" -sourcepath src/ ./src/main/Main.java -classpath "./libs/commons-cli-1.3.1.jar;./libs/commons-codec-1.10.jar;./libs/commons-lang3-3.5.jar;./libs/flyway-core-4.1.2.jar;./libs/h2-1.4.194.jar;./libs/log4j-core-2.8.2.jar;./libs/log4j-api-2.8.2.jar" #
